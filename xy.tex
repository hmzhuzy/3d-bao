\documentclass[aps,prd,twocolumn,superscriptaddress,groupedaddress,nofootinbib]{revtex4}  % for review and submission
...
\begin{abstract}
We propose a new method to reconstruct the primordial (linear) density field
...
nonlinear displacement field using a multigrid
iteration scheme and show the reconstruction results.
The new reconstruction algorithm recovers a lot of linear modes and reduces 
the effect of nonlinear evolution significantly.
This will induce a paradigm shift in the study of large-scale structure and 
open up a new era of precision cosmology.
\end{abstract}
